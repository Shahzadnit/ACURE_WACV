...
if __name__ == "__main__":
    map_dir = '/media/sda1_acces/Code_SPO2/ACURE_WACV/Dataset/VIPLR_data_video'
    base_plot_save_path = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/VIPLR_res/VIPLR_Plots_eval'
    base_model_save_path = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/VIPLR_res/VIPLR_weight'
    checkpoint_dir = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/VIPLR_res/VIPLR_checkpoints'
    fps = 25   # pure_fps:30, BH_rPPG_fps:15
