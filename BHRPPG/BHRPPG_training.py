...
if __name__ == "__main__":
    map_dir = '/media/sda1_acces/Code_SPO2/ACURE_WACV/Dataset/Bh_rPPG_dataset'
    base_plot_save_path = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/BHRPPG_res/BHRPPG_Plots_eval'
    base_model_save_path = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/BHRPPG_res/BHRPPG_weight'
    checkpoint_dir = '/media/sda1_acces/Code_SPO2/ACURE_WACV/results/BHRPPG_res/BHRPPG_checkpoints'
    fps = 15   # pure_fps:30, BH_rPPG_fps:15
